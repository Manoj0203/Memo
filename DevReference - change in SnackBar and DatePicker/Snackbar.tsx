  ...
  const renderChildrenWithWrapper = () => {
    if (typeof children === 'string') {
      return (
        <Text
          variant="bodyMedium"
          style={[styles.content, { color: isDark ? "#fff" : "#000", fontFamily:'Anaheim-SemiBold', fontSize:16 }]}
    ...
    >
      ...
      <Surface
        ...
        style={[
          ...
          styles.container,
          {
            backgroundColor:isDark ? "#252525" : '#eaeaeaff',
            borderRadius: 10,
            opacity: opacity,
            transform: [
              {
        ...
        {...rest}
      >
        <View style={[styles.defaultsidebg, sidebg]}></View>
