            ...
            <SafeAreaView style={{flex:1, backgroundColor:isDark?'#252525':'#fff',}}>
                ...
                <View style={{backgroundColor:isDark?'#151515':'#E6E6E6', width:'92%', left:15, marginTop:10, borderRadius:15, height:225}}>
                    <TextInput placeholder={"Start Typing..."}
                        placeholderTextColor={'gray'}
                        underlineColor={isDark?'#151515':"#E6E6E6"}
                        activeUnderlineColor={isDark?'#151515':"#E6E6E6"}
                        value={feedback}
                        onChangeText={(text) => {setFeedback(text); console.log(feedback);}}
                        cursorColor={isDark?"#abababff": "#252525"}
                        multiline
                        style={styles.feedbackentry}
                        contentStyle={{ backgroundColor: isDark?'#151515':'#E6E6E6', fontFamily:'Anaheim-SemiBold',}}
                        />
                </View>
                <View style={{alignItems:'center'}}>
